    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Row(modifier = Modifier
            ...
            Card(modifier = Modifier
                ...
                .width(200.dp)) {
                Box (modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center){
                    Image(painter = painterResource(id = R.drawable.home2), contentDescription ="home", modifier = Modifier.fillMaxSize())
            ...
            Card(modifier = Modifier
                ...
                .width(200.dp)) {
                Box (modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center){
                    Image(painter = painterResource(id = R.drawable.home4), contentDescription ="home4", modifier = Modifier.fillMaxSize())
